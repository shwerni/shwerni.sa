...
export default function PleaseVerify(props: { phone: string }) {
  // props
    ...
    <div className="cflex gap-5 min-h-semiFull my-20" dir="rtl">
      <div className="cflex gap-10">
        ...
        <div className="cflex gap-5 sm:gap-10">
          ...
          <div className="cflex">
            <Button className="bg-zblue-200" onClick={onSubmit}>
              <LoadingBtn loading={onSend}>تأكيد رقم الهاتف</LoadingBtn>
            </Button>
          </div>
          {/* return home */}
          <Link href="/">
