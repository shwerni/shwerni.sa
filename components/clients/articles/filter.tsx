  ...
  return (
    <div className="mt-3 md:mt-5">
      ...
      <div className="hidden md:flex flex-col gap-5  p-3 border-l border-gray-200">
        <h6 className="text-[#117ED8] text-xl font-medium">فلترة المدونات</h6>
        {children}
      </div>
      {/* mobile */}
  ...
  return (
    <div className="space-y-4">
          ...
          <AccordionContent className="">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <Label htmlFor="r2">الأكثر قراءة</Label>
              </div>
            </RadioGroup>
          </AccordionContent>
        </AccordionItem>
      ...
      <div className="flex justify-center">
        <Button variant="primary" onClick={handleReset} className="w-11/12">
          جميع التصنيفات
        </Button>
      </div>
    </div>
