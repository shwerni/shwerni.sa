...
export default async function Page({
  ...
  // return
  return <EditMeeting meetings={order.meeting} client={order.name} consultant={order.consultant.name} type={order.type} lang="ar" role={UserRole.MANAGER} meeting={meeting} />;
}
